...
export function Intro({ id, sectionRef, disciplines, scrollIndicatorHidden, ...rest }) {
  ...
  return (
    <Section
      className={`${styles.intro} ${styles.rel}`}
      as="section"
      ref={sectionRef}
      id={id}
          ...
          <Fragment>
            ...
            <header className={styles.text}>
              <h1 className={styles.name} data-visible={visible} id={titleId}>
                <DecoderText text="Ecell iiitl presents" delay={500} />
              </h1>
              <Heading level={0} as="h2" className={styles.title}>
                <SEO className={styles.label}>{`Enspire website introduction`}</SEO>
                <span aria-hidden className={styles.row}>
                  ...
                  >
                    <span style={{ color: '#30aebc' }}>E</span>
                    nspire
                  </span>
